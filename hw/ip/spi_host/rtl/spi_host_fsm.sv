...
#(
  ...
  // Two state registers:
  // Actual:   The true state of the FSM, which controls the peripheral IOs and the interations with
  //           the other blocks.
  ...
  assign lead_starting = state_changing && prestall_st_d == WaitLead;
  ...
  assign trail_starting = state_changing && prestall_st_d == WaitTrail;
